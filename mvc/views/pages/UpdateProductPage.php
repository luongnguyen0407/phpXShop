<?php
$data = $data['product'];
$img = json_decode($data['srcImg']);
?>

<div class="content-main">
    <form method="POST" action="./UpdateProduct/Update/<?= $data['maSanPham'] ?>" enctype="multipart/form-data" class="form_add_item">
        <h3>Cập nhật sản phẩm</h3>
        <div class="onetr">
            <label for="tenSP">Tên Sản Phẩm</label>
            <input type="text" name="tenSp" value="<?php echo (isset($data['tenSanPham']) ? $data['tenSanPham'] : '')   ?>">
            <div class="err">
                <span class="has-err">
        ...
        <div class="onetr">
            ...
            <input type="text" name="giaSp" value="<?php echo (isset($data['giaSanPham']) ? $data['giaSanPham'] : '') ?>">
            <div class="err">
                <span class="has-err">
        ...
        <div class="onetr">
            ...
            <?php echo (isset($data['moTa']) ? $data['moTa'] : '') ?>
            </textarea>
            <div class="err">
                <span class="has-err">
        ...
        <img class="img-pview" src="public/imgUp/<?= $img[0] ?>" alt="">
